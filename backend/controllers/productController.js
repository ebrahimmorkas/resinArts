  ...
  try {
    ...
    for (const [productNameLower, productRows] of Object.entries(productGroups)) {
      try {
        ...
        // IMPROVED CATEGORY VALIDATION AND PATH GENERATION
        const { mainCategory, subCategory } = await validateCategoryHierarchy(
          firstRow.mainCategory, 
          firstRow.subCategory
        );

        // Auto-generate category path (ignore user input if provided)
        ...
        // Create base product object with auto-generated category path
        const productData = {
          name: productName,
          mainCategory: mainCategory._id,
          subCategory: subCategory._id,
          categoryPath: autoGeneratedCategoryPath, // Auto-generated, ignoring user input
          productDetails: productDetails,
          image: mainImageUrl,
        ...
        // ... rest of your existing code for handling variants and simple products remains the same ...
        // [Include all the existing variant processing logic here]
        ...
        results.successful.push({
          ...
          categoryPath: autoGeneratedCategoryPath, // Include in response
