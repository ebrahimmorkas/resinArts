...
const AddProduct = () => {
 ...
 const [colorVariants, setColorVariants] = useState([
  ...
  const fetchCategories = useCallback(async () => {
    try {
      ...
      const response = await axios.get("https://resinarts.onrender.com/api/category/all", { withCredentials: true })
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.post("https://resinarts.onrender.com/api/product/add", formDataToSend, {
