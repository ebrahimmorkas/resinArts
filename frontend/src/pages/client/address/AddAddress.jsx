...
const AddAddress = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://api.mouldmarket.in/api/address', formData, {
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Add New Address</h1>
            </div>
            <p className="text-gray-600 dark:text-gray-400">Fill in the details to add a new address</p>
          </div>
