...
const Navbar = ({ onMenuClick, isSidebarOpen }) => {
  ...
  useEffect(() => {
    ...
    const fetchNotifications = async () => {
      try {
        const response = await axios.get('https://api.mouldmarket.in/api/notifications/all', {
          withCredentials: true,
        });
  ...
  const deleteNotification = async (notificationId) => {
    try {
      await axios.delete(`https://api.mouldmarket.in/api/notifications/delete/${notificationId}`, {
        withCredentials: true,
      });
  ...
  const markAllAsRead = async () => {
    try {
      await axios.post('https://api.mouldmarket.in/api/notifications/mark-all-read', {}, {
        withCredentials: true,
      });
                ...
                <>
                  ...
                  <div className="p-4 border-t border-gray-200 bg-gray-50 space-y-2">
                    ...
                    <button
                      onClick={async () => {
                        try {
                          await axios.delete('https://api.mouldmarket.in/api/notifications/clear-all', {
                            withCredentials: true,
                          });
                          setNotifications([]);
