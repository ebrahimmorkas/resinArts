...
const AbandonedCart = () => {
  ...
  useEffect(() => {
    const initSocket = async () => {
      ...
      socketRef.current = io('https://api.mouldmarket.in', { auth: { token }, transports: ['websocket', 'polling'] });
  ...
  const fetchAbandonedCarts = async () => {
    try {
      ...
      const response = await axios.get('https://api.mouldmarket.in/api/abandoned-cart', { withCredentials: true });
  ...
  const confirmDelete = async () => {
    try {
      const axios = (await import('axios')).default;
      const response = await axios.delete(`https://api.mouldmarket.in/api/abandoned-cart/${deleteTarget}`, { withCredentials: true });
  ...
  const confirmDeleteMultiple = async () => {
    try {
      const axios = (await import('axios')).default;
      const response = await axios.post('https://api.mouldmarket.in/api/abandoned-cart/delete-multiple', { ids: selectedRows }, { withCredentials: true });
  ...
  const handleSendReminder = async (id) => {
    try {
      ...
      const axios = (await import('axios')).default;
      const response = await axios.post(`https://api.mouldmarket.in/api/abandoned-cart/send-reminder/${id}`, {}, { withCredentials: true });
