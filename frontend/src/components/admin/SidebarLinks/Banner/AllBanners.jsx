...
const AllBanners = () => {
  ...
  const confirmDefaultUpdate = async () => {
    ...
    try {
      await axios.put(`https://api.simplyrks.cloud/api/banner/update-default/${bannerToUpdateDefault._id}`, {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(`https://api.simplyrks.cloud/api/banner/delete/${bannerToDelete._id}`, {
        withCredentials: true
      });
